    ...
    <div className={styles.container} ref={dropdownRef}>
      ...
      {showDropdown && isAuthenticated && user && (
        <div className={styles.dropdown}>
          ...
          <a
            href="https://github.com/Hira-Tech-GenAi"
            target="_blank"
                ...
                <>
                  ...
                  <div className={styles.formGroup}>
                    ...
                    <div className={styles.checkboxGroup}>
                      {["Python", "C++", "JavaScript", "Rust", "Java"].map(
                        (lang) => (
                          <label key={lang} className={styles.checkbox}>
                            <input
                              type="checkbox"
                              checked={background.preferred_languages.includes(
                                lang
                              )}
                              onChange={() => {
                                toggleLanguage(lang);
                    ...
                    <div className={styles.checkboxGroup}>
                      {[
                        ...
                        <label key={hw} className={styles.checkbox}>
                          <input
                            type="checkbox"
                            checked={background.hardware_access.includes(hw)}
